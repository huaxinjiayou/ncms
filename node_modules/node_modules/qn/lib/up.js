 ...
 *  - {Number} [deadline] 定义 uploadToken 的失效时间，Unix时间戳，精确到秒，缺省为 86400 秒
...
exports.uploadToken = function uploadToken(options) {
  ...
  options.deadline = options.deadline || (utility.timestamp() + 18000);
  var flags = options;
  // 步骤2：将 Flags 进行安全编码
...
exports.upload = function upload(content, options, callback) {
  ...
  var that = this;
  form.field('token', that.uploadToken(options.uploadToken));
